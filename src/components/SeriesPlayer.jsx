...
function SeriesPlayer() {
  ...
  const initVideo = (videoUrl, resumeTime = 0, shouldAutoplay = false) => {
    const video = videoRef.current;
  ...
  useEffect(() => {
    ...
    initVideo(defaultVideoUrl, 0, isFirstVisit);
    initPlyr();
  }, [id]);
